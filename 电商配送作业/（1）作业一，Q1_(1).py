...
class Transshipment_Problem:
    ...
    def algorithm(self):
        ...
        # 约束
        self.model.addConstr(self.x[0, 2] + self.x[0, 3] <= 600, name='')
        self.model.addConstr(self.x[1, 2] + self.x[1, 3] <= 400, name='')
        ...
        self.model.addConstr(- self.x[0, 3] - self.x[1, 3] + self.x[3, 4] + self.x[3, 5] + self.x[3, 6]
                             + self.x[3, 7] == 0, name='')
        self.model.addConstr(self.x[2, 4] + self.x[3, 4] == 200, name='')
        self.model.addConstr(self.x[2, 5] + self.x[3, 5] == 150, name='')
        self.model.addConstr(self.x[2, 6] + self.x[3, 6] == 350, name='')
        self.model.addConstr(self.x[2, 7] + self.x[3, 7] == 300, name='')
