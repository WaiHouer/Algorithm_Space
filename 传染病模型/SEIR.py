...
class SEIR:  # SEIR传染病模型
    def __init__(self,file_name):
        ...
        self.E_0 = 0
        # S_0为易感者的初始人数
        self.S_0 = self.total_population - self.I_0 - self.R_0 - self.E_0

        # SIR组合起来的数组
        self.INI = (self.S_0, self.E_0, self.I_0, self.R_0)
    ...
    def function(self,initial_value,_):  # 方法：微分方程表达式（暂时不懂具体，不过先用着）
        ...
        y[2] = x[1] / self.Te - self.gamma * x[2]  # 感染个体变化
        y[3] = self.gamma * x[2]  # 治愈个体变化
